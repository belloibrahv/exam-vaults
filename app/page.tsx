      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <p className="text-xl text-techvaults-gray-600 mb-8 max-w-2xl mx-auto">
            Prepare for {totalCertifications} cloud certifications across AWS, Azure, and GCP with our comprehensive,
            exam-realistic practice system designed for Techvaults engineers.
          </p>
          ...
          <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            <StatCard number={totalCertifications.toString()} label="Certifications" />
            <StatCard number="3" label="Cloud Providers" />
